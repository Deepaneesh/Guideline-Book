...
**Using R as a Calculator** We can use R as a basic calculator to perform arithmetic operations.
...
But we can also use multiple values for the operation. by using concatenate.
