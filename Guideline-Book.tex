...
\tightlist
\item
  \textbf{Data organization and analysis}
\end{enumerate}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Relative Cell Reference}: Adjusts when copied to another cell
  (e.g., A1).
\item
  \textbf{Absolute Cell Reference}: Remains constant when copied (e.g.,
  \$A\$1). (F4 will make Absolute cell Referencing)
\item
  \textbf{Mixed Cell Reference}: Partially fixed (e.g., A\$1 or \$A1).
\end{enumerate}
